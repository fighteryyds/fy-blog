...
今天使用了Manus，先让它帮我用 Java 做了一个图书管理系统，项目结构很不错，但是无法一次运行，会不断的报错并需要修改。但是它的速度和框架生成速度非常的快，而且它会在做好后提醒你，在此期间你可以干其他的事情。本以为就这样结束了，因为它明天能完成两个任务，所以我给它安排了第二个任务，就是帮助我学习计组当中的乘法与除法，没想到它竟然直接帮我生成了教学文档，并推荐我生成一个永久网站。https://xgpsppao.manus.space/
