...
1.首先我`git checkout 407a`

2.然后我在这个虚构分支中，再找一个文件进行内容修改，我在3.java空文件中写入1234并保存

![ ](article/12246.jpg)

3.接下来使用`git checkout -B 1224`将修改内容保存在1224分支当中，其中的2.Java是我之前做过的了练习(这也说明了它会将所有的修改都保存下来)。

![ ](article/12247.jpg)

这时修改就被保存在了1224分支中

我再将空文件1124.c中输入1234，然后保存在新的分支1224c中，